...
// NOTE: sendScoutRecsToGamePlan() lives in tendencies-render.js (the modern
// _tdScoutRecs-based implementation). A stale duplicate used to live here and,
// because tendencies.js loads AFTER tendencies-render.js, it silently shadowed
// the real one. Removed 2026-07 during the hardening audit. Do not re-add a
// second top-level definition — global-scope duplicates are shadow bugs.

...
### 5. 🟡 P2 S — _(N/A — playbook uses right-click/long-press; no persistent `(•••)` button exists)_
...
_Cross-reference: `UIUX_PERF_ROADMAP.md` covers GPU performance (Phase 1), drag-and-drop optimization (Phase 2), and broader cross-app consistency (Phases 3–6)._

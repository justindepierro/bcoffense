...
assert.match(playPresentation, /let playPresentationTeleHistory = \[\][\s\S]*?let playPresentationTeleHistoryIndex = 0/, "Swipe View keeps a session-local telestrator history cursor");
